      ...
      <div class="top-header-2">
        <div class="d-grid main-top">
          <div class="top-headers">
            <ul>
              <li>
                 <span class="fa fa-phone"></span><a href="tel:+254726178460">+254 726178460</a>
              </li>
            </ul>
          </div>
          <div class="top-headers">
  ...
  <div class="container">
    <nav class="navbar navbar-expand-lg stroke px-0 pt-lg-0">
      <h1> <a class="navbar-brand" href="index.php">
          <span class="fa fa-wifi"></span> WILTEL
        </a></h1>
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav mx-lg-auto">
          ...
          <li class="nav-item @@services__active">
           ...
           <li class="nav-item @@services__active">
            <a class="nav-link" href="services.php">Contact Us</a>
          </li>
        </ul>
...
<section class="w3l-about-breadcrumb">
    <div class="breadcrumb-bg breadcrumb-bg-services py-5">
        <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3 my-5">
        </div>
    </div>
</section>
<!-- //error breadcrumb -->
<div class="display-ad" style="margin: 8px auto; display: block; text-align:center;">
 ...
 <section class="error-page py-5">
     <div class="container py-md-5 py-sm-4 pb-2">
         <div class="main-cover w3">
             <h5 class="cover-para w3ls">App Deelopment stuff </h5>
             <p class="">App Development</p>
